...
public class TestLogin {
    ...
    private String LOGIN_NOMBRE_INCORRECTA = "Longitud nombre incorrecta";
    private String LOGIN_PASSWORD_INCORRECTA = "Longitud contraseña incorrecta";
    ...
    public void testLongitudNombre(){
        ...
        assertEquals(validarLogin.verificarLogin(u),LOGIN_NOMBRE_INCORRECTA);
    ...
    public void testLongitudContrasenia(){
        ...
        u.setNombre("Pepe");
        u.setPassword("12");
        assertEquals(validarLogin.verificarLogin(u),LOGIN_PASSWORD_INCORRECTA);
